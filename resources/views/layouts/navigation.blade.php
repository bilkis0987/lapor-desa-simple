<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <a href="{{ route('home') }}" class="mr-4 text-sm text-gray-500 hover:text-gray-700">Lihat Website</a>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.complaints.index')" :active="request()->routeIs('admin.complaints.*')">Pengaduan</x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('home')">Lihat Website</x-responsive-nav-link>
        </div>
